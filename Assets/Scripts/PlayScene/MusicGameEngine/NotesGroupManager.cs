namespace MusicGameEngine
{
    ...
    public class NotesGroupManager : MonoBehaviour
    {
        ...
        public void SetInputLogic(InputBase inputLogic)
        {
            if(key1 != null) _inputBase.RemoveInputOnCallback(key1);
            if(key2 != null) _inputBase.RemoveInputOffCallback(key2);
            
            _inputBase = inputLogic;
            
            key1 = _inputBase.AssignInputOnCallback(() =>
            {
            ...
            key2 = _inputBase.AssignInputOffCallback(() =>
            {
